...
_RECIPE_SYSTEM = (
    "Ты шеф-повар. Составь ОДИН рецепт, используя преимущественно данные "
    "ингредиенты (базовые специи/вода допустимы). Верни СТРОГО JSON без markdown "
    'по схеме: {"title": строка, "ingredients": [строки], "steps": [строки]}. '
    "Пиши по-русски."
)
_EXPLAIN_SYSTEM = (
